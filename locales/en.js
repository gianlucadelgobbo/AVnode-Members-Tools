{
	...
	"Dear {{result.doc_to.name}}": "Dear {{result.doc_to.name}}",
	"in attach you find the invoice number {{result.doc_number}} of the {{date}}": "in attach you find the invoice number {{result.doc_number}} of the {{date}}",
	...
	"Duplicate": "Duplicate",
	"{{result.doc_to.name}} | Offer number {{result.doc_number}} - {{date}}": "{{result.doc_to.name}} | Offer number {{result.doc_number}} - {{date}}",
	"in attach you find the offer number {{result.doc_number}} of the {{date}}": "in attach you find the offer number {{result.doc_number}} of the {{date}}",
	"Make invoice": "Make invoice",
	"DELETE": "DELETE",
